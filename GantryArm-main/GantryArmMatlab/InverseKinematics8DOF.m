...
clear
% 打开文件以写入Markdown格式
fileID = fopen('D:\Git\GantryArm\GantryArmMatlab\InverseKinematics8DOF1.md', 'w');  % 创建并打开output.md文件
...
% 确保使用符号变量
syms d0 d1 d2 theta3 theta4 theta5 theta6 theta7 Load real  % Define all joint angles as symbolic variables
