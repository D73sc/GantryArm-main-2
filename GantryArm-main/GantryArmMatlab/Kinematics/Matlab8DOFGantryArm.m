...
%定义关节角度限制
lim0_min = 0 ; lim0_max = 3100 ; %-400，2700
lim1_min = 0 ; lim1_max = 2000 ; 
lim2_min = 100 ; lim2_max = 1800 ; 
lim3_min = 0 * radian1; lim3_max = 360 * radian1; 
lim4_min = 0 * radian1; lim4_max = 85 * radian1; 
lim5_min = -180 * radian1; lim5_max = 180 * radian1; 
lim6_min = -90 * radian1; lim6_max = 90 * radian1;
lim7_min = -45 * radian1; lim7_max = 45 * radian1; 
...
% 构建数据文件路径
filename = fullfile(current_dir, 'data_output.xlsx');
